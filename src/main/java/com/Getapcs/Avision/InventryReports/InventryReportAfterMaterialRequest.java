...
public class InventryReportAfterMaterialRequest extends TestBase {
	...
	public InventryReportAfterMaterialRequest() {
...
//Part Type
		...
		driver.navigate().to("https://demo_keus.getapcs.com/transaction/material-request");
