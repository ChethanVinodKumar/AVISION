package com.Getapcs.Avision.SecondaryMaster;
...
public class NumberOfRoom extends TestBase {
	...
	@FindBy(xpath = "(//a[normalize-space()='Number Of Room'])[1]")
	WebElement numberOfRoom;

	@FindBy(xpath = "(//i[@class='mdi mdi-plus-box-outline edit-icon'])[1]")
	WebElement createnumberOfRoom;

	@FindBy(xpath = "(//input[@placeholder='Enter Number Of Room Name'])[1]")
	WebElement numberOfRoomField;
	...
	public HomePage NumberOfRoomCreate(String name, String description, String remarks) {
		// TODO Auto-generated method stub

		threeLinesSideBarIcon.click();
		master1.click();
		numberOfRoom.sendKeys(Keys.ENTER);

		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", createnumberOfRoom);

		// 1Verifying that Nature of Relationship Name Text Field is Enabled or not
		boolean isEnabledAuditNatureOFRelationshipField = numberOfRoomField.isEnabled();
		assertTrue(isEnabledAuditNatureOFRelationshipField);
		boolean isDisabledNatureOFRelationshipTextFieldn = !numberOfRoomField.isEnabled();
		...
		boolean isDisplayedNatureOFRelationshipTextField = numberOfRoomField.isDisplayed();
		assertTrue(isDisplayedNatureOFRelationshipTextField);
		boolean isHiddenNatureOFRelationshipTextField = !numberOfRoomField.isDisplayed();
		assertFalse(isHiddenNatureOFRelationshipTextField);

		// Verifying that Nature of Relationship Name Text Field is Selected or
		// unselected
		boolean isSelectedNatureOFRelationshipTextField = numberOfRoomField.isSelected();
		assertFalse(isSelectedNatureOFRelationshipTextField);
		boolean isDeselectedNatureOFRelationshipTextField = !numberOfRoomField.isSelected();
		...
		// text field.
		String displayedTextInNatureOFRelationship = numberOfRoomField.getAttribute("placeholder");

		String expected_placeholder3 = "Enter Number Of Room Name";
		...
		numberOfRoomField.clear();
		numberOfRoomField.sendKeys(name);
	...
	public HomePage NumberOfRoomEdit(String description, String remarks) {
		// TODO Auto-generated method stub
